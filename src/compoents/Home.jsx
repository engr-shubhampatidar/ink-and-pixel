...
const Home = () => {
    ...
    return (
        ...
        >
        <Navbar/>
            <div className='h-[95vh]  max-xl:h-full w-full flex flex-col justify-evenly items-center'>
                <div className='w-[70%] h-fit flex flex-col justify-center items-center'>
                    ...
                    <h2 className='line-hieght max-xl:leading-5 text-[75px] leading-[78px] max-lg:text-2xl max-lg:leading-6 text-center font-[700] mt-[25px]'>Crafting Scalable Web Solutions with Modern Tech & Clean Architecture</h2>
                    <p
